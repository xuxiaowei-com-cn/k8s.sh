...
| pod-network-cidr                          | 指明 Pod 网络可以使用的 IP 地址段。如果设置了这个参数，控制平面将会为每一个节点自动分配 CIDR。注意：请勿与现实网络存在冲突                                                                                                          | 空                                                                                                                                              | pod-network-cidr=10.120.0.0/12 （即：10.120.0.0-10.135.255.255，共 1048576 个IP）                                                                                            |
