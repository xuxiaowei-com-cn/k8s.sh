...
| calico-version                            | 指定 calico 版本                                                                                                                                                                  | 3.2                                                                                                                                            | calico-version=3.26.1                                                                                                                                                 |
| calico-manifests-mirror                   | 自定义 calico 配置文件，优先级高于 calico-version                                                                                                                                          | 从 官网 中获取                                                                                                                                       | calico-manifests-mirror=https://jihulab.com/mirrors-github/projectcalico/calico/-/raw/v3.26.1/manifests/calico.yaml                                                   |
...
| ingress-nginx-controller-mirror           | 自定义镜像，用于替换国内不可访问的 registry.k8s.io/ingress-nginx/controller 镜像                                                                                                                 | xuxiaoweicomcn/ingress-nginx-controller                                                                                                        | ingress-nginx-controller-mirror=registry.jihulab.com/xuxiaowei-cloud/xuxiaowei-cloud/ingress-nginx/controller                                                         |
| ingress-nginx-kube-webhook-certgen-mirror | 自定义镜像，用于替换国内不可访问的 registry.k8s.io/ingress-nginx/kube-webhook-certgen 镜像                                                                                                       | xuxiaoweicomcn/ingress-nginx-kube-webhook-certgen                                                                                              | ingress-nginx-kube-webhook-certgen-mirror=registry.jihulab.com/xuxiaowei-cloud/xuxiaowei-cloud/ingress-nginx/kube-webhook-certgen                                     |
...
2. k8s 单节点安装（只有一个主节点，无高可用，仅用于学习、测试），使用 k8s 指定版本
    ...
    # 在 JiHuLab 查看 k8s 发布的版本（作者个人镜像）：https://jihulab.com/mirrors-github/kubernetes/kubernetes/-/tags
...
6. k8s 单节点安装（只有一个主节点，无高可用，仅用于学习、测试），使用 calico 指定版本
    ...
    # 查看 calico 发布的版本（作者 JiHuLab 镜像）：https://jihulab.com/mirrors-github/projectcalico/calico/-/tags
