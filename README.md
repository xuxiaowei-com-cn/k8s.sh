...
| calico-manifests-mirror         | 自定义 calico 配置文件，优先级高于 calico-version                                             | 从 官网 中获取     | calico-manifests-mirror=https://jihulab.com/xuxiaowei-com-cn/k8s.sh/-/raw/SNAPSHOT/0.2.0/mirrors/projectcalico/calico/v3.25/manifests/calico.yaml        |
