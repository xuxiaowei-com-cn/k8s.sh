...
| calico-manifests-mirror         | 自定义 calico 配置文件，优先级高于 calico-version                                                                                                                                          | 从 官网 中获取                                                                                                                                       | calico-manifests-mirror=https://gitcode.net/mirrors/projectcalico/calico/-/raw/v3.26.1/manifests/calico.yaml                                                          |
...
6. k8s 单节点安装（只有一个主节点，无高可用，仅用于学习、测试），使用 calico 指定版本
    ...
    # 查看 calico 发布的版本（GitCode 镜像）：https://gitcode.net/mirrors/projectcalico/calico/-/tags
    ./k8s.sh kubernetes-taint calico-version=3.26.1
    ```
